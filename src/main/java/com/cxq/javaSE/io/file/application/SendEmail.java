package com.cxq.javaSE.io.file.application;
    ...
    public static void main(String[] args)
    {
    	try{
        	...
        	for(int i = 0; i < count ; i ++){
    	        ...
    	        String usename = "chenxiaoqin@git.com.cn";
    	        sendMail.setSmtpServer("smtp.git.com.cn");
    	        //此处设置登录的用户名
    	        sendMail.setUsername(usename);
    	        ...
    	        sendMail.setPassword("R2QRbUznuPy9ue3D");
    	        //设置收件人的地址
    	        sendMail.setTo("kezunshuai@git.com.cn");
    	        //设置发送人地址
    	        sendMail.setFrom(usename);
    	        //设置标题
    	        sendMail.setSubject("哥真帅");
    	        //设置内容
...
//    	        sendMail.attachfile("E:/‪time.jpg");
    	        if (sendMail.send())
    	        {
    	            System.out.println("第" + (i + 1) + "次邮件发送成功，时间：" + date);
    	        }
